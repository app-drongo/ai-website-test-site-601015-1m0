      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Button
              variant="ghost"
              className="text-lg font-bold text-foreground hover:text-primary p-0 h-auto"
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                <div className="flex flex-col space-y-4 mt-8">
                  ...
                  <Button
                    variant="ghost"
                    className="text-lg font-bold text-foreground hover:text-primary justify-start p-0 h-auto"
                    onClick={handleBrandClick}
                    data-editable-href="brandHref"
                    data-href={config.brandHref}
                  >
                  ...
                  <div className="flex flex-col space-y-2">
                    {config.navItems.map((item, idx) => (
                      <Button
                        key={idx}
                        variant="ghost"
                        className="text-foreground hover:text-primary hover:bg-accent justify-start px-3 py-2 text-base font-medium"
                        onClick={() => handleNavClick(item.href)}
                        data-editable-href={`navItems[${idx}].href`}
                        data-href={item.href}
                      >
